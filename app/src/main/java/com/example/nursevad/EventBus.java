...
public class EventBus {
    ...
    private final MutableLiveData<Boolean> vadRunning = new MutableLiveData<>(false);
    ...
    public void postVadRunning(boolean running) { vadRunning.postValue(running); }
    public LiveData<Boolean> getVadRunning() { return vadRunning; }
}